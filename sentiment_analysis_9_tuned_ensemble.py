...
decision_tree_model = DecisionTreeClassifier(**dt_params)
logistic_regression_model = LogisticRegression(**lr_params)
random_forrest_classifier = RandomForestClassifier(**rf_params)
